            ...
            <div className='container'>
                <div className='mx-auto flex max-w-7xl flex-col gap-6'>
                    <h2 className='text-pretty text-3xl font-bold lg:text-5xl'>
                        Choose the Perfect Plan for Your Rides
                    </h2>

                    <div className='flex flex-col justify-between gap-10 md:flex-row'>
                        <p className='text-muted-foreground max-w-3xl lg:text-xl'>
                            Whether you ride occasionally or daily, we’ve got a
                            plan that saves you money and gives you the
                        ...
                        <div className='flex w-full flex-col rounded-lg border p-6 text-left'>
                            ...
                            <div className='flex h-full flex-col justify-between gap-20'>
                                <ul className='text-muted-foreground space-y-4'>
                                    ...
                                    <li className='flex items-center gap-2'>
                                        <Check className='size-4' />
                                        <span>20 rides/month included</span>
                                    </li>
                                    <li className='flex items-center gap-2'>
                                        <Check className='size-4' />
                                        <span>Priority ride booking</span>
                                    </li>
                                    <li className='flex items-center gap-2'>
                                        <Check className='size-4' />
